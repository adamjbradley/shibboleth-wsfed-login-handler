...
public class WSFedPasiveLoginHandlerBeanDefinitionParser extends AbstractLoginHandlerBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(WSFedPassiveNamespaceHandler.NAMESPACE, "wsfed");

    /** {@inheritDoc} */
    protected Class getBeanClass(Element element) {
        return WSFedLoginHandlerFactoryBean.class;
    }
